import { PrismaClient, RestaurantFeature, PriceRange, CuisineType } from '@prisma/client';
...
const restaurantsWithFeatures = [
  ...
  },
  {
    ...
    cuisine: [CuisineType.JAPANESE, CuisineType.SUSHI],
  ...
  },
  {
    ...
    cuisine: [CuisineType.INTERNATIONAL, CuisineType.FUSION],
    priceRange: PriceRange.MODERATE,
    rating: 4.2,
    capacity: 100,
    features: [
  ...
  },
  {
    ...
    cuisine: [CuisineType.EUROPEAN, CuisineType.INTERNATIONAL],
    priceRange: PriceRange.MODERATE,
    rating: 4.5,
    capacity: 120,
    features: [
  ...
  },
  {
    ...
    cuisine: [CuisineType.AMERICAN, CuisineType.STEAKHOUSE],
